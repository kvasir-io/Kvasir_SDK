...
namespace Io {
    ...
    constexpr Register::PinLocation<TPort::value, TPin::value> makePinLocation(TPort, TPin) {
        return {};
    }
}   // namespace Io
namespace Register {
    template<typename TAction, typename T>
    constexpr Io::Detail::MakeActionIfPinLocationT<TAction, T> action(TAction, T) {
        return {};
    }

    template<typename T>
    constexpr Io::Detail::
      MakeActionIfPinLocationT<Io::Action::Input<Io::PullConfiguration::PullNone>, T>
      makeInput(T) {
        return {};
    }
    ...
    constexpr Io::Detail::MakeActionIfPinLocationT<
      Io::Action::Output<Io::OutputType::PushPull, Io::OutputSpeed::Low>,
      T>
    makeOutput(T) {
        return {};
    }
    ...
    constexpr Io::Detail::MakeActionIfPinLocationT<Io::Action::Set, TPortPin> set(TPortPin) {
        return {};
    }

    template<typename TPortPin>
    constexpr Io::Detail::MakeActionIfPinLocationT<Io::Action::Clear, TPortPin> clear(TPortPin) {
        return {};
    }

    template<typename TPortPin>
    constexpr Io::Detail::MakeActionIfPinLocationT<Io::Action::Toggle, TPortPin> toggle(TPortPin) {
        return {};
    }

    template<typename TPP1, typename TPP2, typename... TPortPins>
    constexpr brigand::list<
      Io::Detail::MakeActionIfPinLocationT<Io::Action::Toggle, TPP1>,
    ...
    template<typename TPortPin>
    constexpr Io::Detail::MakeActionIfPinLocationT<Io::Action::Read, TPortPin> read(TPortPin) {
        return {};
    }
