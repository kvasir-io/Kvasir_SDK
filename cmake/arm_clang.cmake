...
if("${CPPLIB}" STREQUAL "libstdc++"
  ...
  execute_process(
    ...
    OUTPUT_STRIP_TRAILING_WHITESPACE)
  string(REGEX MATCH "^install: ([^\n\r ]*)" GCC_ARM_NONE_EABI_LIB_DIR
               ${GCC_ARM_NONE_EABI_LIB_DIR})
  string(REGEX REPLACE "^install: " "" GCC_ARM_NONE_EABI_LIB_DIR
                       ${GCC_ARM_NONE_EABI_LIB_DIR})

  get_filename_component(GCC_ARM_NONE_EABI_ROOT "${GCC_ARM_NONE_EABI_ROOT}"
                         REALPATH)
...
set(CMAKE_C_LINK_EXECUTABLE
    "${Python3_EXECUTABLE} ${kvasir_cmake_dir}/tools/two_stage_link.py ${CMAKE_SIZE} \
...
if("${CPPLIB}" STREQUAL "libstdc++")
  list(APPEND system_includes ${GCC_ARM_NONE_EABI_INCLUDE}
       ${GCC_ARM_NONE_EABI_INCLUDE}/arm-none-eabi
...
# -rtlib=compiler_rt -m32 -DLIBCXXABI_BAREMETAL
