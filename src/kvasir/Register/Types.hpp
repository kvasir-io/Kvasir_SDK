...
namespace Kvasir { namespace Register {
    ...
    template<
      ...
      typename... TRs>
    struct FieldTuple<
      brigand::list<brigand::uint32_t<Is>...>,
      brigand::list<FieldLocation<TAs, Masks, TAccesss, TRs>...>> {
        ...
        brigand::at_c<brigand::list<TRs...>, Index> get() const {
            ...
            static constexpr unsigned index = sizeof...(Is)
        ...
        using ConvertableTo = typename std::conditional<
          (sizeof...(TRs) == 1),
    ...
    auto get(T, TFieldTuple o)
      -> decltype(o.template get<Detail::GetFieldLocationIndex<TFieldTuple, T>::value>()) {
    ...
    bool operator==(TFieldTuple const& f, FieldValue<TLocation, Value> const) {
