...
struct pair_wrapper_ {
    static_assert(sizeof...(T) == 2, "as_pair requires a type list of exactly two types");
...
namespace detail {
    ...
    struct all_impl<Sequence<Ts...>, Predicate>
      : std::is_same<
          bools_<true, invoked<Predicate, Ts>::value...>,
...
namespace detail {
    ...
    struct reverse_elements<
      ...
      Ts...>
      : append_impl<
          typename reverse_elements<L, Ts...>::type,
...
struct bind {
    ...
    struct apply {
        using type = brigand::apply<
          detail::bind_impl_t<MetafunctionClass, list<Us...>>,
...
namespace detail {
    ...
    public:
        ...
        template<class K>
        static wrap<decltype(exact_eraser<T...>::erase(type_<K>{})), detail::set_impl>
          erase(type_<K>);
