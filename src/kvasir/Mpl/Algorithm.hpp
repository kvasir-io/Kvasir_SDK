...
namespace Kvasir { namespace MPL {
    namespace Detail {
        ...
        struct Join {
            static_assert(AlwaysFalse<TOut>::value,
                          "Incorrect parameter format, expected list of lists");
        };

        template<typename... Os, typename TDelim, typename... Ls, typename... Ts>
        struct Join<brigand::list<Os...>, TDelim, brigand::list<Ls...>, Ts...>
          : Join<brigand::list<Os..., TDelim, Ls...>, TDelim, Ts...> {};

        template<typename... Os, typename TDelim>
        struct Join<brigand::list<Os...>, TDelim>
          : Return<brigand::list<Os...>> {};   // no more input, done
        ...
        struct Split<brigand::list<Os...>, brigand::list<Cs...>, TDelim, T, Ts...>
          :   // next is not delim, we still have more
              Split<brigand::list<Os...>, brigand::list<Cs..., T>, TDelim, Ts...> {};

        template<typename... Os, typename... Cs, typename TDelim, typename T>
        struct Split<brigand::list<Os...>,
                     brigand::list<Cs...>,
                     TDelim,
                     T> {   // next is not delim, we do not have
                            // more
            using type = brigand::list<Os..., brigand::list<Cs..., T>>;
        };

        template<typename... Os, typename... Cs, typename TDelim, typename... Ts>
        struct Split<brigand::list<Os...>, brigand::list<Cs...>, TDelim, TDelim, Ts...>
          :   // next is delim, we still have more
        ...
        struct Split<brigand::list<Os...>,
                     brigand::list<Cs...>,
                     TDelim,
                     TDelim> {   // next is delim, we have no more
        ...
        struct Split<brigand::list<Os...>, brigand::list<>, TDelim, TDelim, Ts...>
          :   // next is delim, we still have more
        ...
        template<typename T_Out,
                 template<typename, typename> class T_Pred,
                 typename T_Insert,
                 bool B_Tag,
                 typename... Ts>
        struct SortInsert;
        ...
        template<typename... Os,
                 ...
                 typename T2,
                 typename... Ts>
        struct SortInsert<brigand::list<Os...>, T_Pred, T_Insert, true, T1, T2, Ts...>
          : SortInsert<brigand::list<Os..., T1>,
                       T_Pred,
                       T_Insert,
                       T_Pred<T2, T_Insert>::value,
                       T2,
                       Ts...> {};
        ...
        template<typename O,
                 ...
                 typename TInsert,
                 typename... Ts>
        struct Sort<brigand::list<O, Os...>, TPred, TInsert, Ts...>
          : Sort<typename Detail::
                   SortInsert<brigand::list<>, TPred, TInsert, TPred<O, TInsert>::value, O, Os...>::
                     type,
                 TPred,
                 Ts...> {};
        ...
        template<typename... Os,
                 ...
                 typename TInsert,
                 typename... Ts>
        struct Sort<brigand::list<Os...>, TPred, TInsert, Ts...>
          : Sort<typename Detail::SortInsert<brigand::list<>, TPred, TInsert, false, Os...>::type,
                 TPred,
                 Ts...> {};
        ...
        struct Remove<brigand::list<Os...>, From, To, T, Ts...>
          : Remove<brigand::list<Os..., T>, From - 1, To - 1, Ts...> {};

        template<typename... Os, int To, typename T, typename... Ts>
        struct Remove<brigand::list<Os...>, 0, To, T, Ts...>
          : Remove<brigand::list<Os...>, 0, To - 1, Ts...> {};
        ...
        template<typename... Rs,
                 ...
                 typename U,
                 typename V,
                 typename... Ts>   // not same
        struct Unique<false, brigand::list<Rs...>, Pred, T, U, V, Ts...>
          : Unique<Pred<U, V>::value, brigand::list<Rs..., T>, Pred, U, V, Ts...> {};
        ...
        template<typename... Rs,
                 ...
                 typename V,
                 typename... Ts>   // same
        struct Unique<true, brigand::list<Rs...>, Pred, T, U, V, Ts...>
          : Unique<Pred<U, V>::value, brigand::list<Rs...>, Pred, U, V, Ts...> {};

    }   // namespace Detail

    template<typename TList, typename TIndex>
    struct At {
        static_assert(AlwaysFalse<TList>::value,
                      "implausible parameters");
    };
    ...
    struct Find {
        static_assert(AlwaysFalse<TToFind>::value,
                      "implausible parameters");
    };
    ...
    struct Find<brigand::list<T, Ts...>, Template<Pred>>
      : Detail::PredFind<0, Pred<T>::value, Pred, Ts...> {};
    ...
    struct Contains<brigand::list<Ts...>, TToFind>
      : NotT<IsSameT<typename Detail::Find<0, TToFind, Ts...>::type, Int<-1>>> {};
    ...
    struct Remove<brigand::list<T, Ts...>, Int<From>, Int<To>>
      : Detail::Remove<brigand::list<>, From, To, T, Ts...> {};

    template<typename... Ts, template<typename> class TPred>
    struct Remove<brigand::list<Ts...>, Template<TPred>, void>
      : brigand::flatten<brigand::list<
          typename std::conditional<TPred<Ts>::value, brigand::list<>, Ts>::type...>> {};

    template<typename TList, typename TFrom, typename TTo = void>
    using RemoveT = typename Remove<TList, TFrom, TTo>::type;

    // expects a sorted list, removes all consecutive duplicates fulfilling pred
    ...
    struct Unique<brigand::list<T, U, Ts...>, Template<TPred>>
      : Detail::Unique<TPred<T, U>::value, brigand::list<>, TPred, T, U, Ts...> {};
    ...
    template<typename... Ts, template<typename> class TPred>
    struct CountIf<brigand::list<Ts...>, Template<TPred>>
      : SumT<brigand::list<typename TPred<Ts>::type...>> {};
