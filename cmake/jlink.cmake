function(target_add_flash_jlink target)
  ...
  file(
    CONFIGURE
    OUTPUT ${target}_flash.jlink
    CONTENT "${jlink_connect_command}loadfile ${target}${PARSED_ARGS_SUFFIX}\nr\nh\nr\ng\nq"
    NEWLINE_STYLE UNIX
  )
  ...
  set(
    jlink_args
    -If SWD
    -Device ${PARSED_ARGS_TARGET_MPU}
    -Speed ${PARSED_ARGS_SWD_SPEED}
    -ExitOnError 1
    -NoGui 1
  )
  ...
  if(NOT TARGET ${aux_suffix}reset)
    file(
      CONFIGURE
      OUTPUT ${aux_suffix}reset.jlink
      CONTENT "${jlink_connect_command}r\ng\nq"
      NEWLINE_STYLE UNIX
    )
    ...
    file(
      CONFIGURE
      OUTPUT ${aux_suffix}connect.jlink
      CONTENT "${jlink_connect_command}"
      NEWLINE_STYLE UNIX
    )
    ...
    set_property(
      ...
      ${CMAKE_CURRENT_BINARY_DIR}/${aux_suffix}reset.jlink
