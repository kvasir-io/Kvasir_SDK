...
namespace Kvasir { namespace Io {
    ...
    constexpr MPL::
      EnableIfT<Detail::IsPinLoaction<T>::value, Port<PortAccess::defaultMode, T, Ts...>>
      makePort(T, Ts...) {
        return {};
    }
    template<typename T, typename... Ts>
    ...
    template<typename TPort>
    constexpr MPL::EnableIfT<Detail::IsPort<TPort>::value, Detail::PortMakeOutputT<TPort>>
    makeOutput(TPort) {
        return {};
    }

    template<typename TPort>
    constexpr MPL::EnableIfT<Detail::IsPort<TPort>::value, Detail::PortMakeInputT<TPort>>
    makeInput(TPort) {
        return {};
    }
    ...
    template<typename TPort>
    constexpr MPL::EnableIfT<Detail::IsPort<TPort>::value, Detail::WriteRuntimeToPortT<TPort>>
    write(TPort, unsigned value) {
