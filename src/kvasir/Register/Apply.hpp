...
namespace Kvasir { namespace Register {
    ...
    namespace Detail {
        ...
        template<
          ...
          typename... TInputs2>
        struct IndexedActionLess<
          IndexedAction<Action<T1, U1>, TInputs1...>,
        ...
        struct MergeRegisterActions<
          brigand::list<
            IndexedAction<
              Action<
                FieldLocation<TAddress, Mask1, TAccess1, TFieldType1>,
          ...
          brigand::list<
            IndexedAction<
              Action<
                FieldLocation<TAddress, Mask2, TAccess2, TFieldType2>,
        ...
        struct MergeRegisterActions<
          brigand::list<
            IndexedAction<
              Action<FieldLocation<TAddress, Mask1, TAccess1, TFieldType1>, ReadAction>,
              TInputs1...>,
            Ts...>,
          brigand::list<
            IndexedAction<
              Action<FieldLocation<TAddress, Mask2, TAccess2, TFieldType2>, ReadAction>,
              TInputs2...>,
            Us...>>
          : MergeRegisterActions<
              brigand::list<Ts...>,
        ...
        struct MergeRegisterActions<
          brigand::list<
            IndexedAction<
              Action<FieldLocation<TAddress, Mask1, TAccess1, TFieldType1>, WriteAction>,
              TInputs1...>,
            Ts...>,
          brigand::list<
            IndexedAction<
              Action<FieldLocation<TAddress, Mask2, TAccess2, TFieldType2>, WriteAction>,
              TInputs2...>,
            Us...>>
          : MergeRegisterActions<
              brigand::list<Ts...>,
        ...
        struct MergeActionSteps<brigand::list<Ts...>> {
            using type = brigand::list<MergeRegisterActionsT<brigand::sort<
              brigand::flatten<Ts>,
        ...
        using GetReadsT = brigand::transform<
          brigand::
            remove_if<brigand::flatten<brigand::list<TArgList...>>, IsNotReadPred<brigand::_1>>,
        ...
        constexpr bool noneRuntime() {
            ...
            return brigand::size<
                     brigand::remove_if<FlattenedActions, IsNotRuntimeWritePred<brigand::_1>>>::
                     value
                == 0;
        }
        ...
        void noReadNoRuntimeWriteApply(brigand::list<TActions...>*) {
            const std::array a{0U, ExecuteSeam<TActions, ::Kvasir::Tag::User>{}(0U)...};
            ignore(a);
        }
        ...
        struct ArgsToApplyArePlausible {
            ...
            using type                 = MPL::Bool<std::is_same<
    ...
    inline typename std::enable_if<
      (brigand::size<Detail::GetReadsT<brigand::list<Args...>>>::value != 0),
      Detail::GetReturnType<Args...>>::type
    apply(Args... args) {
        static_assert(
          Detail::ArgsToApplyArePlausible<Args...>::value,
          "one of the supplied arguments is not supported");
        using IndexedActions = brigand::transform<
          brigand::list<Args...>,
        ...
        using Inputs           = brigand::
          transform<Actions, brigand::quote<Detail::GetInputs>>;   // list of lists of lits of
                                                                   // unsigned seperators
